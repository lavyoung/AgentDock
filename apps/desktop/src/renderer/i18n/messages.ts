...
export const messages: Record<Locale, Catalog> = {
    "zh-CN": {
        ...
        projectsEmpty: "\u8fd8\u6ca1\u6709\u9879\u76ee\uff0c\u5148\u521b\u5efa\u4e00\u4e2a\u5de5\u4f5c\u533a\uff0c\u4f5c\u4e3a\u573a\u666f\u7684\u540c\u6b65\u843d\u70b9\u3002",
        ...
        projectWorkflowMovedDesc: "\u573a\u666f\u9875\u8d1f\u8d23\u53d1\u8d77\u540c\u6b65\uff0c\u9879\u76ee\u9875\u53ea\u4fdd\u7559\u76ee\u5f55\u914d\u7f6e\u4e0e\u540c\u6b65\u5386\u53f2\u3002",
    ...
    en: {
        ...
        projectsEmpty: "No projects yet. Create a workspace to act as a scenario sync destination.",
        ...
        projectWorkflowMovedDesc: "Sync is now initiated from the scenario page. The project page only keeps directory configuration and sync history.",
