...
export interface AgentdockApi {
    ...
    applications: {
        ...
        previewScenarioSync(id: ApplicationId, scenarioId: string): Promise<SyncPreviewResult>;
        runScenarioSync(id: ApplicationId, scenarioId: string): Promise<SyncRunResult>;
    };
    sync: {
        preview(input: SyncPreviewInput): Promise<SyncPreviewResult>;
        run(input: SyncPreviewInput): Promise<SyncRunResult>;
        cleanup(input: SyncCleanupInput): Promise<SyncCleanupResult>;
    };
}
