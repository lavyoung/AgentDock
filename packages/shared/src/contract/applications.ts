/**
 * Transport contract types for applications and their managed locations.
 *
 * `ApplicationId` and the location kind/scope/source enums are duplicated from
 * `packages/core/src/types/application.ts` because the core package owns the
 * canonical domain values. The two copies must stay in sync.
 */
